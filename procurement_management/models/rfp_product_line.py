...
class RFPProductLine(models.Model):
    ...
    unit_price = fields.Monetary(string='Unit Price', required=False)
    ...
    @api.depends('quantity', 'supplier_unit_price', 'delivery_charges_supplier')
    def _compute_subtotal(self):
        for line in self:
            line.subtotal_price = (line.quantity * line.supplier_unit_price) + (line.delivery_charges_supplier or 0)
